...
export const PAGES: AppPage[] = [
  ...
  { key: "bcc-purchase-orders", path: "/central-bank/transactions/purchase-orders", labelFr: "Ordre d’achat", labelEn: "Purchase Order", group: "central_bank" },
  { key: "bcc-receipt-assay", path: "/central-bank/receipts/receipt-assay", labelFr: "Receipt & Assay", labelEn: "Receipt & Assay", group: "central_bank" },
  { key: "bcc-receipts", path: "/central-bank/receipts", labelFr: "Liste des réceptions", labelEn: "Receipt List", group: "central_bank" },
  { key: "bcc-pricing-settlement", path: "/central-bank/settlements/pricing-settlement", labelFr: "Pricing & Settlement", labelEn: "Pricing & Settlement", group: "central_bank" },
  { key: "bcc-settlements", path: "/central-bank/settlements", labelFr: "Règlements", labelEn: "Settlements", group: "central_bank" },
  { key: "bcc-confirmations", path: "/central-bank/confirmations", labelFr: "Liste des confirmations", labelEn: "Confirmation List", group: "central_bank" },
  { key: "bcc-custody", path: "/central-bank/confirmations/custody", labelFr: "Custody Confirmation", labelEn: "Custody Confirmation", group: "central_bank" },
  { key: "bcc-valuations", path: "/central-bank/valuations", labelFr: "Valorisations", labelEn: "Valuations", group: "central_bank" },
