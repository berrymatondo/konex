    ...
    <div className="space-y-5">
      ...
      <Tabs defaultValue="details">
        ...
        <TabsContent value="trace" className="mt-4"><RefiningPanel icon={Box} title={fr ? "Chaîne de garde et de provenance" : "Custody & provenance chain"}><Timeline items={[
          ...
          { state: "done", title: "Refining order created & approved — GAC-REF-2026-014", meta: "22/07/2026 · dual approval complete" },
          { state: confirmed ? "done" : "current", title: "Dispatch & chain of custody — GAC-DSP-2026-014", meta: confirmed ? (fr ? "Expédition confirmée" : "Dispatch confirmed") : (fr ? "Cette étape · scellés, poids, transport et assurance" : "This step · seals, weight, transport & insurance") },
