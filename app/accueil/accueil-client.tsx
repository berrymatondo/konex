...
const CITIES: Array<{ name: string; position: string; delay: number }> = [
  { name: "Kinshasa", position: "top-[15%] right-[5%] md:right-[10%]", delay: 0 },
  { name: "New York", position: "bottom-[25%] left-[0%] md:left-[5%]", delay: 1 },
  { name: "Dubai", position: "top-[40%] right-[0%] md:right-[5%]", delay: 2 },
  { name: "London", position: "bottom-[15%] right-[10%] md:right-[15%]", delay: 0.5 },
  { name: "Zurich", position: "bottom-[25%] right-[20%] md:right-[15%]", delay: 1.5 },
];
...
const THEME_VARS = {
  ...
  "--ring": "#d4af37",
  backgroundImage: "radial-gradient(circle at 50% 0%, #1a2333 0%, #0f172a 100%)",
...
function AmbientDots() {
  const [dots, setDots] = useState<Array<{ top: number; left: number; delay: number; duration: number }>>([]);
    ...
    <div className="fixed inset-0 pointer-events-none">
      {dots.map((d, i) => (
        <div
          ...
          style={{ top: `${d.top}%`, left: `${d.left}%`, animationDelay: `${d.delay}s`, animationDuration: `${d.duration}s` }}
        />
      ))}
    </div>
  );
...
export function AccueilClient() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground font-sans antialiased" style={THEME_VARS}>
      <style>{`
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-20 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Left column — copy */}
            <Reveal from="-translate-x-12" className="order-2 lg:order-1 text-center lg:text-left space-y-6 sm:space-y-8">
              <div className="inline-flex items-center gap-2 backdrop-blur-md bg-[#1e293b99] border border-white/5 px-4 py-2 rounded-full text-sm mx-auto lg:mx-0">
                ...
                <span className="text-muted-foreground">Plateforme de Gestion des Réserves en Or</span>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                <span className="text-foreground">La Référence pour les</span>
                <br />
                <span className="text-primary [text-shadow:0_0_10px_rgba(212,175,55,0.3)]">Réserves d&apos;Or</span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Button size="lg" variant="outline" asChild className="border-primary/30 hover:bg-primary/10">
                  <Link href="/documentation">Découvrir les Fonctionnalités</Link>
                </Button>
              </div>
            ...
            <Reveal from="scale-90" className="order-1 lg:order-2 h-[400px] sm:h-[450px] lg:h-[550px] relative flex flex-col items-center">
              <div className="text-center mb-4 lg:absolute lg:top-0 lg:left-1/2 lg:-translate-x-1/2 lg:z-10">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground mt-1 uppercase tracking-[0.2em]">Gold Reserve Management</p>
              </div>
              <div className="flex-1 w-full">
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  <div className="relative w-[280px] h-[280px] md:w-[400px] md:h-[400px]">
                    <div className="absolute inset-0 rounded-full border-2 border-primary/30" style={{ animation: "accueil-spin 20s linear infinite" }}>
                    ...
                    <div className="absolute inset-6 md:inset-8 rounded-full border border-primary/20" style={{ animation: "accueil-spin 15s linear infinite reverse" }}>
                    ...
                    <div className="absolute inset-12 md:inset-16 rounded-full border border-primary/10" style={{ animation: "accueil-spin 25s linear infinite" }} />
                    <div className="absolute inset-16 md:inset-20 rounded-full bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 shadow-[inset_0_0_60px_rgba(0,0,0,0.5)] overflow-hidden">
                      <div className="absolute inset-0 flex flex-col justify-around opacity-20">
                        {Array.from({ length: 5 }).map((_, i) => <div key={i} className="h-px bg-primary/60" />)}
                      </div>
                      <div className="absolute inset-0 flex justify-around opacity-20">
                        {Array.from({ length: 5 }).map((_, i) => <div key={i} className="w-px bg-primary/60" />)}
                      </div>
                      <div className="absolute top-[25%] left-[30%] w-2 h-2 bg-primary rounded-full animate-pulse shadow-[0_0_10px_rgba(212,175,55,0.8)]" />
                      <div className="absolute top-[35%] left-[55%] w-1.5 h-1.5 bg-primary/80 rounded-full animate-pulse" style={{ animationDelay: "0.5s" }} />
                      <div className="absolute top-[45%] left-[40%] w-1 h-1 bg-primary/60 rounded-full animate-pulse" style={{ animationDelay: "1s" }} />
                      <div className="absolute top-[55%] left-[65%] w-2 h-2 bg-primary rounded-full animate-pulse shadow-[0_0_10px_rgba(212,175,55,0.8)]" style={{ animationDelay: "1.5s" }} />
                      <div className="absolute top-[40%] left-[25%] w-1.5 h-1.5 bg-primary/70 rounded-full animate-pulse" style={{ animationDelay: "2s" }} />
                      <div className="absolute top-[60%] left-[35%] w-1 h-1 bg-primary/50 rounded-full animate-pulse" style={{ animationDelay: "0.3s" }} />
                    </div>
                    <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" style={{ animation: "accueil-spin 30s linear infinite" }}>
                      <defs>
                        <linearGradient id="accueil-arc-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="rgba(212,175,55,0)" />
                          <stop offset="50%" stopColor="rgba(212,175,55,0.8)" />
                          <stop offset="100%" stopColor="rgba(212,175,55,0)" />
                        </linearGradient>
                      </defs>
                      <path d="M100,200 Q200,80 300,200" fill="none" stroke="url(#accueil-arc-gradient)" strokeWidth="2" className="animate-pulse" />
                      <path d="M150,300 Q200,180 250,100" fill="none" stroke="url(#accueil-arc-gradient)" strokeWidth="1.5" className="animate-pulse" style={{ animationDelay: "1s" }} />
                    </svg>
                  </div>
            ...
            <Reveal>
              <div className="backdrop-blur-md bg-[#1e293b99] border border-white/5 rounded-2xl p-6 sm:p-8 md:p-12">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Pourquoi les Reserves en Or ?</h2>
                </div>
                <div className="space-y-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
                  <p>
                    Chaque banque nationale est tenue de constituer des réserves en devises étrangères, communément appelées réserves
                    d&apos;État. En complément, elle doit également détenir des actifs stables, notamment de l&apos;or.
                  </p>
                  <p>
                    Toutefois, cet or doit répondre à des exigences strictes : il doit être raffiné selon des standards reconnus et
                    certifié par des organismes accrédités, notamment la{" "}
                    <span className="text-primary font-medium">London Bullion Market Association (LBMA)</span>.
                  </p>
                  <p>
                    <span className="text-foreground font-medium">Konex</span>{" "}a pour mission d&apos;accompagner les banques à chaque
                    étape de ce processus. Cela inclut l&apos;acquisition d&apos;or brut, son raffinage auprès d&apos;entités certifiées,
                    puis sa validation officielle afin de garantir sa conformité aux normes internationales.
                  </p>
                </div>
              </div>
            </Reveal>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <Reveal className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
              De l&apos;acquisition à la certification, Konex couvre l&apos;ensemble du cycle de vie des réserves en or de votre
              institution.
            </p>
          </Reveal>
          ...
          <Reveal from="scale-95">
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 text-center py-12 sm:py-16 px-4 sm:px-6">
                <Earth className="w-12 h-12 sm:w-16 sm:h-16 text-primary mx-auto mb-6 animate-pulse" aria-hidden="true" />
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4">Prêt à Sécuriser vos Réserves ?</h2>
                <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto mb-8">
                  Rejoignez les banques centrales qui font confiance à Konex pour la gestion stratégique de leurs réserves en or.
                </p>
                <Button size="lg" asChild className="gap-2 group">
                  <Link href="/sign-in">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground text-sm">Reserve Management System</span>
            </div>
            <div className="text-sm text-muted-foreground">2024 Konex. Tous droits réservés.</div>
          </div>
        </div>
      </footer>
    </div>
